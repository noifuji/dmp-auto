...
ICON_COST_WHITE_1 = "MESSAGE_LAST_SP_BATTLE.png"
...
MESSAGE_EFFECT = "MESSAGE_LAST_SP_BATTLE.png"
...
MESSAGE_BOUNCE = Pattern("1602826851330.png").similar(0.86)
MESSAGE_MANA = Pattern("1602826590510.png").similar(0.87)
...
MESSAGE_SELECT = "MESSAGE_LAST_SP_BATTLE.png"
