...
ICON_ENEMY_TAPPED_CREATURE_2 = Pattern("ICON_ENEMY_TAPPED_CREATURE_2.png").similar(0.90).targetOffset(-7,-60)
...
ICON_ENEMY_CREATURE4 = Pattern("ICON_ENEMY_CREATURE4.png").similar(0.89).targetOffset(-18,-33)
