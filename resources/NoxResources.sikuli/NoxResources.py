...
ICON_MISSION_WITH_SIGN = Pattern("1603101517477.png").similar(0.87)
...
ICON_MY_UNTAPPED_BLOCKER = Pattern("1603409783512.png").similar(0.85)#Pattern("1596903270708.png").similar(0.80).targetOffset(-4,74)
