...
ICON_CLOVER = Pattern("1608817846601.png").similar(0.95)
ICON_CLOVER_WITH_SIGN = Pattern("1608817801774.png").similar(0.95)
...
BUTTON_CITY_BATTLE = "1612247974473.png"
...
BUTTON_QUICK_PICK = Pattern("1623474506210.png").similar(0.92)
BUTTON_PROFILE = "BUTTON_PROFILE.png"
BUTTON_ACCOUNT_LINK = Pattern("1622734202651.png").similar(0.83)
BUTTON_LINK_TWITTER = Pattern("1625622318651.png").similar(0.92)
BUTTON_LINKED_TWITTER = Pattern("1625622366669.png").similar(0.89)
...
TITLE_SETTINGS = "1619091583218.png"
BUTTON_GAME_SETTINGS ="1619091566445.png"
#################QuickPick#######################
BUTTON_ENTER_USING_TICKT = Pattern("1623474779653.png").similar(0.98)#"1623474807283.png"
BUTTON_CREATE_DECK = "1623475056594.png"
BUTTON_SELECT = Pattern("1623475159194.png").similar(0.94)
BUTTON_QUICKPICK_RETIRE = "BUTTON_QUICKPICK_RETIRE.png"
BUTTON_QUICKPICK_REWARD = "BUTTON_QUICKPICK_REWARD.png"
...
TITLE_LEGEND_STAGE3 = Pattern("1616142496739.png").similar(0.95)
TITLE_LEGEND_STAGE4 = Pattern("1616142514846.png").similar(0.95)
#################MainStory####################
...
MESSAGE_NO_OPPONENTS = "1601976850151.png"#Pattern("OK.png").similar(0.67)
...
BUTTON_DMPP04 = "1621136668682.png"
BUTTON_DMPP05 = "1621136622617.png"
